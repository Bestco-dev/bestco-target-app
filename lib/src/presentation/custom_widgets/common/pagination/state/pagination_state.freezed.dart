...
class _$PaginationStateImpl<T> extends _PaginationState<T> {
  ...
  @override
  String toString() {
    return 'PaginationState<$T>(entities: $entities, errorMessage: $errorMessage, loadMoreError: $loadMoreError, offset: $offset, limit: $limit, loadingMore: $loadingMore, isRefresh: $isRefresh, initialize: $initialize, endReached: $endReached)';
  }
