...
class CalendarAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  ///definition of your specific shade of white
  final Color? white;

  ///definition of your specific shade of black
  final Color? black;
  ...
  ///definition of the attribute which shows full calendar view when pressing on date
  final bool? fullCalendar;

  ///[backButton] shows BackButton in set to true
  final bool? backButton;

  ///definition of the calendar language
  final String? locale;
...
class _CalendarAppBarState extends State<CalendarAppBar> {
  ///definition of [selectedDate] variable of current selected date
  late DateTime selectedDate;

  ///definition of [firstDate] variable of current selected date
  late DateTime firstDate;

  ///definition of [position] variable of current selected calendar card
  late int position;
  ...
  void initState() {
    setState(() {
      ///initializing accent
      accent = widget.accent ?? ResColors.primary;
  ...
  Widget build(BuildContext context) {
    ...
    ///initializing first date and setting it to midnight
    DateTime first =
        DateTime.parse("${firstDate.toString().split(" ").first} 00:00:00.000");

    ///initializing last date and setting it to 11 pm due to the time saving
      ...
      return Container(
        ...
        child: NotificationListener(
          onNotification: (dynamic notification) {
            ...
            ///definition of offset which is the distance from scrolling beginning
            double offset = scrollController.offset;

            ///handling situation if user finished drag when scrolling but scrollview
            ///is still moving
            if (notification is UserScrollNotification &&
              ...
              ///compare last last selected date with current selected date
              ///if date has changed return new selected date
              if (referenceDate.toString().split(" ").first !=
                  selectedDate.toString().split(" ").first) {
                ///wait that animation is finished and than call function [onDateChange]
            ...
            if (offset > position * widthUnit - (widthUnit / 2)) {
              setState(() {
                ...
                ///adding haptic feedback in the future
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    ///different UI for unselected containers and the selected ones
            ...
            child: FullCalendar(
              ...
              onDateChange: (value) {
                ...
                Future.delayed(const Duration(milliseconds: 100), () {
                  ...
                  ///counting current offset based of current position
                  double newOffset =
                      (offset + (widthUnit * positionDifference));

                  ///if current offset is out of boundaries set it to maximal or minimal offset
                  ...
                  Future.delayed(const Duration(milliseconds: 550), () {
                    setState(() {
                      ///set selected date to current value
                      selectedDate = value;

                      ///set reference date to selected date
                      referenceDate = selectedDate;
...
class _FullCalendarState extends State<FullCalendar> {
  ...
  ///definition of week row that shows the day of the week for specific week
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
              fontSize: 18.0, color: widget.black, fontWeight: FontWeight.w400),
        ),
        Padding(
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: GridView.builder(
              ...
              ///Since each calendar is drawn separately it shouldn't be scrollable
