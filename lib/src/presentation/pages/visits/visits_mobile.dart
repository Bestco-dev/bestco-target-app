...
import '../visits_curd/visit_curd.dart';

class VisitsMobilePage extends ConsumerStatefulWidget {
  const VisitsMobilePage({Key? key}) : super(key: key);
  @override
  ConsumerState<VisitsMobilePage> createState() => _CheckMobilePageState();
}

class _CheckMobilePageState extends ConsumerState<VisitsMobilePage> {
  int selectedTap = 0;
  @override
        ...
        CustomCard(
          ...
          child: ListTile(
            ...
            title: Container(
              ...
              child: Text(visit.customer?.name??''),
            ),
            subtitle: Column(
              children: [
