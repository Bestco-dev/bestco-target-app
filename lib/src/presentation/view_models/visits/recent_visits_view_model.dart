...
//
// final recentVisitsViewModelProvider =
//     StateNotifierProvider<RecentVisitsViewModel, UiState<List<VisitModel>>>(
//         (ref) => RecentVisitsViewModel(ref: ref));
//
// class RecentVisitsViewModel extends StateNotifier<UiState<List<VisitModel>>> {
//   final Ref ref;
//
//   RecentVisitsViewModel({required this.ref}) : super(const UiState.initial());
//
